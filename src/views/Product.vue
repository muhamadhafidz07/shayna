                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :nav="false" :autoplay="true">
                                    <div class="pt" @click="changeImages(thumbs[0])" :class="thumbs[0] == image_default ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImages(thumbs[1])" :class="thumbs[1] == image_default ? 'active' : ''">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImages(thumbs[2])" :class="thumbs[2] == image_default ? 'active' : ''">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImages(thumbs[3])" :class="thumbs[3] == image_default ? 'active' : ''">
